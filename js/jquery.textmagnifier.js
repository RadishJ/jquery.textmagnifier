	...
	var privateFunction = {
		...
		_resize : function ($this) {
            ...
            switch(settings.align) {
				...
				case 'left' : {
					$div.css( { 'top': ori_top + 'px' , 'left': ori_left - ( ori_width + settings.alignlen ) + 'px' } );
				};break;
				...
				case 'bottom' : {
					$div.css( {  'top': ( ori_top + ori_height + settings.alignlen ) + 'px' , 'left': ori_left + 'px' } );
				};break;

				default : {
					$div.css( { 'top' : ori_top - ( settings.height + settings.alignlen ) + 'px' , 'left' : ori_left + 'px' } );
				};
			}
		},
